...
pub fn run() {
    ...
    let result = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::catalog_scan,
            commands::list_missing,
            commands::relink_missing,
            commands::relink_folder,
            commands::forget_missing,
            commands::list_events,
            commands::create_event,
            commands::rename_event,
            commands::delete_event,
            commands::add_to_event,
            commands::remove_from_event,
            commands::set_event_cover,
